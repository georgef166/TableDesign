...
- 📊 **AG Grid** table with the full locate column set — Request Date, Type, Batch ID,
  Locate ID, Status, SEDOL, ISIN, RIC, CUSIP, Ticker, BBG Ticker, Security,
  Qty Requested / Qty Approved.
...
- 📌 Pinned columns, sorting, resizing, and pagination out of the box.
